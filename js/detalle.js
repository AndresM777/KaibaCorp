...
$(function () {
    ...
    // 2) Lista de productos (catálogo base) — sin "código quemado" en el HTML
    const listaProductos = [
        { id: 1, titulo: "Deportivo Furia X90", imagen: "img/porsche.jpg", precio: 150000, descripcion: "Potencia extrema y diseño aerodinámico. 0-100 km/h en 3.2s. Disponible en rojo y negro.", galeria:["img/3porsche.jpg"] },
        { id: 2, titulo: "SUV Aventura GT",    imagen: "img/Mazda.jpg",   precio:  75000, descripcion: "Lujo y capacidad para toda la familia. Tracción 4x4, asientos de cuero y tecnología avanzada.",   galeria:["img/3mazda.jpg"] },
        { id: 3, titulo: "Clásico Leyenda 68",  imagen: "img/2toyota.jpg",  precio:  90000, descripcion: "Un ícono restaurado a la perfección. Motor V8, pintura original y piezas de colección.",        galeria:["img/2toyota.jpg"] },
        { id: 4, titulo: "EcoDrive E7",         imagen: "img/1mazda.jpeg",  precio:  65000, descripcion: "Auto 100% eléctrico con autonomía de 500 km. Carga rápida y diseño futurista.",               galeria:["img/1mazda.jpeg"] },
        { id: 5, titulo: "Pickup Titan X",      imagen: "img/2toyota.jpg",  precio:  82000, descripcion: "Potente y resistente. Ideal para trabajo pesado y aventuras extremas con estilo premium.",     galeria:["img/2toyota.jpg"] }
    ];
